...
export default function HeaderTest({ showNav, setShowNav }: HeaderTestProps) {
  return (
    <div
      ...
      <div className="flex items-center pr-4 md:pr-16">
        <Popover className="relative">
          <Popover.Button className="outline-none mr-5 md:mr-8 cursor-pointer text-gray-700">
            <StockIconApple className="h-6 w-6" />
          </Popover.Button>
          <Transition
            as={Fragment}
                ...
                <div className="mt-4 grid gap-4 grid-cols-1 overflow-hidden">
                  <div className="flex">
                    <div className="rounded-full shrink-0 bg-green-200 h-8 w-8 flex items-center justify-center">
                      <StockIconApple className="h-4 w-4 text-green-600" />
                    </div>
                    <div className="ml-4">
        ...
        <Menu as="div" className="relative inline-block text-left">
          <div>
            <Menu.Button className="inline-flex w-full justify-center items-center">
              ...
              <StockIconApple className="ml-2 h-4 w-4 text-gray-700" />
            </Menu.Button>
          </div>
          <Transition
            as={Fragment}
              ...
              <div className="p-1">
                <Menu.Item>
                  <Link
                    ...
                    <StockIconApple className="h-4 w-4 mr-2" />
                    Edit
                  </Link>
                </Menu.Item>
                <Menu.Item>
